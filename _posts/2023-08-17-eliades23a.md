...
abstract: "We propose an ensemble learning approach to tackle\r the problem of concept
  drift (CD) in data-stream\r classification. Accurately detecting the change\r point
  ...
  expensive. More specifically, we\r employ an ensemble of ten classifiers that use
  ...
  p-value sequence, we perform a\r retraining process of the corresponding\r classifier.
